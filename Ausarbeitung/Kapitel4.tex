...
\begin{figure}[h!]
	...
	\begin{subfigure}[b]{0.4\textwidth}
		...
		\subcaption{Abbildung "NR FEHLT" \cite{.MH_Bus}}
	\end{subfigure}
	\begin{subfigure}[b]{0.4\textwidth}
		\includegraphics[width=\linewidth]{tree_topology.jpg}
		\subcaption{Abbildung "NR FEHLT" \cite{.MH_Tree}}
	\end{subfigure}
	\begin{subfigure}[b]{0.4\textwidth}
		\includegraphics[width=\linewidth]{star_topology.jpg}
		\subcaption{Abbildung "NR FEHLT" \cite{.MH_Star}}
	\end{subfigure}
