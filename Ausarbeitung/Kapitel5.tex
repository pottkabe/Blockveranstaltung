	...
	\section{Sensoren}
		...
		In der vorliegenden Grafik werden sämtliche Sensoren aufgezeigt:
			\begin{figure}
				...
				\caption{Übersicht der Sensoren im Automobil \cite{TS01}:}
			...
			Für einen besseren Überblick werden in diesem Kapitel die Sensoren des Automobils begutachtet, aufgelistet und erläutert.	
				...
				\subsubsection{Begriffsdefinition}
					...
					\begin{itemize}
						...
						\item Aufnehmer
					\end{itemize}
					welche eine physikalische Größe oder chemische Effekte durch messtechnische Verfahren aufnimmt und in ein analoges, elektrisches Signal konvertiert.
