...
\begin{figure}[h!]
	...
	\begin{subfigure}[b]{0.4\textwidth}
		...
		\subcaption[{https://2.bp.blogspot.com/-R-uihxzRU6g/WOIFGLjqtMI/AAAAAAAAEdg/X3YgTGUxQ8MSCbm14OsABMnhWUTK-Ee-gCLcB/s1600/bus_topology.jpg]{Bus}
		\label{fig:bus}
	\end{subfigure}
	\begin{subfigure}[b]{0.4\textwidth}
		\includegraphics[width=\linewidth]{stern-topology.jpg}
		\subcaption[http://slideplayer.org/slide/791365/2/images/3/Sternstruktur+(Ethernet+Twisted+Pair).jpg]{Stern}
		\label{fig:stern}
	\end{subfigure}
	\begin{subfigure}[b]{0.4\textwidth}
		\includegraphics[width=\linewidth]{tree-topology.jpg}
		\subcaption[http://units.folder101.com/cisco/sem1/Notes/ch2-topologies/tree.gif]{Baum}
		\label{fig:baum}
	\end{subfigure}
