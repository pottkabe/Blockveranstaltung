...
\begin{figure}[h!]
	...
	\begin{subfigure}[b]{0.4\textwidth}
		...
		\subcaption[{https://2.bp.blogspot.com/-R-uihxzRU6g/WOIFGLjqtMI/AAAAAAAAEdg/X3YgTGUxQ8MSCbm14OsABMnhWUTK-Ee-gCLcB/s1600/bus_topology.jpg]{Abbildung 4.1}
	\end{subfigure}
	\begin{subfigure}[b]{0.4\textwidth}
		\includegraphics[width=\linewidth]{stern_topology.jpg}
		\subcaption[http://slideplayer.org/slide/791365/2/images/3/Sternstruktur+(Ethernet+Twisted+Pair).jpg]{Abbildung 4.2}
	\end{subfigure}
	\begin{subfigure}[b]{0.4\textwidth}
		\includegraphics[width=\linewidth]{tree_topology.jpg}
		\subcaption[http://units.folder101.com/cisco/sem1/Notes/ch2-topologies/tree.gif]{Abbildung 4.3}
	\end{subfigure}
